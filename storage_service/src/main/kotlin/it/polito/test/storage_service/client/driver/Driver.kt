...
interface Driver {
     ...
     */
    fun writeOnDisk(kafkaTemplate: KafkaTemplate<String, Message<Any>>, topic: String, filename: String, data: ByteArray, metadata: MutableMap<String, String>, message: String = "File must be saved on disk")
     ...
     */
    fun writeOnDiskWithStats(kafkaTemplate: KafkaTemplate<String, Message<Any>>, topic: String, filename: String, data: ByteArray, metadata: MutableMap<String, String>)
}